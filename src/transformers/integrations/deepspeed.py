...
def deepspeed_load_checkpoint(deepspeed_engine:DeepSpeedEngine, checkpoint_path, load_module_strict=True, stage = None):
    ...
    if len(deepspeed_checkpoint_dirs) > 0:
        ...
        if stage in ["DMOLE_BEFORE_TRAIN", "DMOLE_TRAIN"]:
